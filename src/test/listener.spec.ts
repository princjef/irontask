...
describe('Listener', () => {
  ...
  it(
    'receives and completes a pending task automatically on return',
    async () => {
  ...
  it(
    'allows the task to be updated while processing',
    async () => {
      const scoped = client.type('listen-simple');
  ...
  it(
    'renews the lock multiple times if necessary',
    async () => {
      const scoped = client.type('listen-renewLock');
  ...
  it(
    'can be completed with an overridden next run time',
    async () => {
  ...
  it(
    'can be passed a custom delay on retry',
    async () => {
  ...
  it(
    'can be explicitly failed for permanent errors',
    async () => {
  ...
  it(
    'can be deferred to be redelivered without consuming retries',
    async () => {
  ...
  it(
    'can be released to be redelivered immediately without consuming retries (used for disable)',
    async () => {
  ...
  it(
    'can be deleted while processing',
    async () => {
  ...
  it(
    'can be force released to stop processing without informing the database (use as last resort)',
    async () => {
  ...
  it(
    'does not retry if the NO_RETRY constant is provided',
    async () => {
      const scoped = client.type('listen-throw');
  ...
  it(
    'does not allow multiple finishing calls to be made concurrently',
    async () => {
  ...
  it(
    'does not allow multiple finishing calls to be made consecutively if already finished',
    async () => {
  ...
  it(
    'does not allow finishing calls to be made if the lock was already lost',
    async () => {
  ...
  it(
    'is notified if the currently running task is disabled',
    async () => {
  ...
  it(
    'does nothing if forceRelease is called after task processing finishes',
    async () => {
  ...
  it(
    'can be serialized via util inspect (console.log)',
    async () => {
  ...
  it(
    'limits the number of active tasks to the concurrency specified',
    async () => {
  ...
  it(
    'marks appropriate tasks for automatic cleanup',
    async () => {
  ...
  it(
    'keeps the automatic cleanup time up to date as the task is saved',
    async () => {
  ...
  it(
    'lets currently running tasks finish when stopping',
    async () => {
  ...
  it(
    'automatically releases all active tasks when destroying',
    async () => {
  ...
  it(
    'lets tasks that are currently finishing finish before releasing them when destroying',
    async () => {
  ...
  it(
    'does not allow an already destroyed client to be destroyed again (avoids race conditions)',
    async () => {
  ...
  describe('interceptors', () => {
    it(
      'captures information about the request',
      async () => {
    ...
    it(
      'throws if it tries to call next multiple times',
      async () => {
